...
int main( int argc, char** argv )
{
    ...
    //读取图像
    frame1.rgb = cv::imread( "/home/yh/myslam/data/rgb1.png" );
    frame1.depth = cv::imread( "/home/yh/myslam/data/depth1.png", -1);
    frame2.rgb = cv::imread( "/home/yh/myslam/data/rgb2.png" );
    frame2.depth = cv::imread( "/home/yh/myslam/data/depth2.png", -1 );
    ...
    PointCloud::Ptr output (new PointCloud());  //类构造函数
    pcl::transformPointCloud( *cloud1, *output, T.matrix() );
    *output += *cloud2;
    pcl::io::savePCDFile("/home/yh/myslam/data/result.pcd", *output);
